...
: FieldBase( field, "" ) {}
  ...
  char getValue() const QF_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, "" ) {}
  ...
  double getValue() const QF_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, "" ) {}
  ...
  int getValue() const QF_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, "" ) {}
  ...
  bool getValue() const QF_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, UtcTimeStampConvertor::convert( UtcTimeStamp(), precision ) ) {}
  ...
  UtcTimeStamp getValue() const QF_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, UtcDateConvertor::convert( UtcDate() ) ) {}
  ...
  UtcDate getValue() const QF_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, UtcTimeOnlyConvertor::convert( UtcTimeOnly(), precision ) ) {}
  ...
  UtcTimeOnly getValue() const QF_THROW( IncorrectDataFormat )
    { try
