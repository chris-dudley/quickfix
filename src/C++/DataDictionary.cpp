...
message_order const& DataDictionary::getHeaderOrderedFields() const QF_THROW( ConfigError )
{
...
message_order const& DataDictionary::getTrailerOrderedFields() const QF_THROW( ConfigError )
{
...
const message_order &DataDictionary::getMessageOrderedFields(const std::string & msgType) const QF_THROW( ConfigError )
{
