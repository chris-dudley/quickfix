...
int MySQLStore::getNextSenderMsgSeqNum() const QF_THROW( IOException )
{
  return m_cache.getNextSenderMsgSeqNum();
}

int MySQLStore::getNextTargetMsgSeqNum() const QF_THROW( IOException )
{
  return m_cache.getNextTargetMsgSeqNum();
}

void MySQLStore::setNextSenderMsgSeqNum( int value ) QF_THROW( IOException )
{
  std::stringstream queryString;
...
void MySQLStore::setNextTargetMsgSeqNum( int value ) QF_THROW( IOException )
{
  std::stringstream queryString;
...
void MySQLStore::incrNextSenderMsgSeqNum() QF_THROW( IOException )
{
  m_cache.incrNextSenderMsgSeqNum();
  setNextSenderMsgSeqNum( m_cache.getNextSenderMsgSeqNum() );
}

void MySQLStore::incrNextTargetMsgSeqNum() QF_THROW( IOException )
{
  m_cache.incrNextTargetMsgSeqNum();
  setNextTargetMsgSeqNum( m_cache.getNextTargetMsgSeqNum() );
}

UtcTimeStamp MySQLStore::getCreationTime() const QF_THROW( IOException )
{
  return m_cache.getCreationTime();
}

void MySQLStore::reset() QF_THROW( IOException )
{
  std::stringstream queryString;
...
void MySQLStore::refresh() QF_THROW( IOException )
{
  m_cache.reset();
  populateCache(); 
}
