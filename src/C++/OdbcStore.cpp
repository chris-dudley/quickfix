...
int OdbcStore::getNextSenderMsgSeqNum() const QF_THROW( IOException )
{
  return m_cache.getNextSenderMsgSeqNum();
}

int OdbcStore::getNextTargetMsgSeqNum() const QF_THROW( IOException )
{
  return m_cache.getNextTargetMsgSeqNum();
}

void OdbcStore::setNextSenderMsgSeqNum( int value ) QF_THROW( IOException )
{
  std::stringstream queryString;
...
void OdbcStore::setNextTargetMsgSeqNum( int value ) QF_THROW( IOException )
{
  std::stringstream queryString;
...
void OdbcStore::incrNextSenderMsgSeqNum() QF_THROW( IOException )
{
  m_cache.incrNextSenderMsgSeqNum();
  setNextSenderMsgSeqNum( m_cache.getNextSenderMsgSeqNum() );
}

void OdbcStore::incrNextTargetMsgSeqNum() QF_THROW( IOException )
{
  m_cache.incrNextTargetMsgSeqNum();
  setNextTargetMsgSeqNum( m_cache.getNextTargetMsgSeqNum() );
}

UtcTimeStamp OdbcStore::getCreationTime() const QF_THROW( IOException )
{
  return m_cache.getCreationTime();
}

void OdbcStore::reset() QF_THROW( IOException )
{
  std::stringstream queryString;
...
void OdbcStore::refresh() QF_THROW( IOException )
{
  m_cache.reset();
  populateCache(); 
}
