...
int PostgreSQLStore::getNextSenderMsgSeqNum() const QF_THROW( IOException )
{
  return m_cache.getNextSenderMsgSeqNum();
}

int PostgreSQLStore::getNextTargetMsgSeqNum() const QF_THROW( IOException )
{
  return m_cache.getNextTargetMsgSeqNum();
}

void PostgreSQLStore::setNextSenderMsgSeqNum( int value ) QF_THROW( IOException )
{
  std::stringstream queryString;
...
void PostgreSQLStore::setNextTargetMsgSeqNum( int value ) QF_THROW( IOException )
{
  std::stringstream queryString;
...
void PostgreSQLStore::incrNextSenderMsgSeqNum() QF_THROW( IOException )
{
  m_cache.incrNextSenderMsgSeqNum();
  setNextSenderMsgSeqNum( m_cache.getNextSenderMsgSeqNum() );
}

void PostgreSQLStore::incrNextTargetMsgSeqNum() QF_THROW( IOException )
{
  m_cache.incrNextTargetMsgSeqNum();
  setNextTargetMsgSeqNum( m_cache.getNextTargetMsgSeqNum() );
}

UtcTimeStamp PostgreSQLStore::getCreationTime() const QF_THROW( IOException )
{
  return m_cache.getCreationTime();
}

void PostgreSQLStore::reset() QF_THROW( IOException )
{
  std::stringstream queryString;
...
void PostgreSQLStore::refresh() QF_THROW( IOException )
{
  m_cache.reset();
  populateCache(); 
}
